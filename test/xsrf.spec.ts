...
describe('xsrf', () => {
      ...
      afterEach(() => {
          ...
          document.cookie = axios.defaults.xsrfCookie + '=;expires=' + new Date(Date.now() - 86400000).toUTCString()
     })
       ...
       test('should set xsrf header for cross origin when using wityCredentials', () => {
              axios('http://example.com/')
